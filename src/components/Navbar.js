    ...
    <div className="bg-yt-black h-14 flex items-center pl-4 pr-5 justify-between fixed w-full z-10">
      <div className="w-full flex justify-between items-center">
        ...
        <div className="h-10 flex flex-row items-center">
          <div className="w-[37rem] bg-yt-black flex border border-yt-light-black items-centere rounded-3xl h-10">
            <input
              type="text"
              placeholder="Search"
              className="w-full bg-yt-black h-full ml-6 text-yt-white text-start focus:outline-none pl-4"
            />
            <button className="w-16 h-10 bg-yt-light-black px-2 py-0.5 rounded-r-3xl border-yt-light-black">
              <HiMagnifyingGlass
                size={22}
                className="text-yt-white font-thin"
              />
            </button>
          </div>
        ...
        <div className="flex items-center justify-center">
          <div className="flex flex-row items-center">
            <div className="p-2 hover:bg-yt-light-black rounded-full cursor-pointer">
              <BiVideoPlus size={25} className="text-yt-white text-center" />
            </div>
            <div className="flex items-center justify-center w-10 h-10 hover:bg-yt-light-black rounded-full cursor-pointer">
              <FaRegBell size={20} className="text-center text-yt-white" />
            </div>
            <div className="w-[7.5rem] h-[2.25rem] mx-3 cursor-pointer rounded-3xl border border-1 border-yt-gray">
              <button className="w-full h-full flex items-center justify-center gap-x-2  text-[#3ea6ff] font-bold text-[14px]">
                <PiUserCircleThin className="text-[#3ea6ff]" size={24} />
                Sign in
              </button>
            </div>
          </div>

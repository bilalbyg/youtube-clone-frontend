  ...
  return (
    <div className="w-full h-full fill-current">
      <svg
        ...
        viewBox="0 0 97 20"
        width={size}
        className="w-full pointer-events-none block h-full"
        focusable="false"
      >
        <svg
          viewBox="0 0 97 20"
...
const PlayIcon = ({ size }) => {
  return (
    <svg
      ...
      viewBox="0 0 24 24"
    >
      <path fill="currentColor" d="m7 4 12 8-12 8V4z"></path>
    </svg>
  );
};

const TriDotsIcon = ({ size }) => {
  return (
    <svg
      role="img"
      height={size}
...
const CommentIcon = ({ size }) => {
  return (
    <svg
      ...
      viewBox="0 0 16 16"
    >
      <path fill="currentColor" d="M12 3v8.59l-1.29-1.3-.3-.29H4V3h8m1-1H3v9h7l3 3V2ZM9 7H5v1h4Zm2-2H5v1h6Z"></path>{" "}
    </svg>
  );
};
